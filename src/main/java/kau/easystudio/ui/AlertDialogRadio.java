...
public class AlertDialogRadio  extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) { // 다이얼로그 창
        ...
        if(theme == 1){
            b.setTitle("#Calm Down");
            b.setSingleChoiceItems(theme1.calmdown, position, musicListener);
        }else if(theme == 2){
            b.setTitle("#Chill Out");
            b.setSingleChoiceItems(theme2.chillout, position, musicListener);
        }else if(theme == 3){
            b.setTitle("#Coffee Break");
            b.setSingleChoiceItems(theme3.coffeebreak, position, musicListener);
        }else if(theme == 4){
            b.setTitle("#Daily Lift");
            b.setSingleChoiceItems(theme4.dailylift, position, musicListener);
        }else if(theme == 5){
            b.setTitle("#Epic Party");
            b.setSingleChoiceItems(theme5.epicparty, position, musicListener);
        }else{
            b.setTitle("#Road Trip");
            b.setSingleChoiceItems(theme6.roadtrip, position, musicListener);
        }
